...
import TabsNavbar from "@/modules/app/components/molecules/TabsNavbar.vue";
...
const routes: Array<RouteRecordRaw> = [
    {
        ...
        children: [
            ...
            },
            {
                ...
                path: '/popular-prayers/:prayer',
                name: 'popular-prayer',
                component: () => import('../components/organism/prayers/PopularPrayerPage.vue')
            }, {
                path: '/saint',
                name: 'Saint',
